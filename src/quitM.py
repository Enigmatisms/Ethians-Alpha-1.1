...
class Quitting:
    def __init__(self, surface):
        ...
        self.quitBk=pygame.image.load(os.path.join("asset", "quitBk.png")).convert_alpha()
        self.covButton=pygame.image.load(os.path.join("asset", "covQuit.png")).convert_alpha()
        self.btList=[0,0,0]
